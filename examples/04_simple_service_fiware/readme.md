...
- [run_simple_service.ipynb](./run_simple_service.ipynb): Notebook to run the service (or directly using [encodapy.service.service_main](./../../encodapy/service/service_main.py))
...
This shows the basic function of a service connected to the FIWARE platform without using components. It is recommended to use the component structure instead — see the example [06_thermal_storage_service](./../06_thermal_storage_service/) or [07_component_runner](./../07_component_runner/).
