...
The FlixOpt model schema is implemented in [flixopt_models.py](https://github.com/gewv-tu-dresden/encodapy/blob/v0.10.2/encodapy/components/flixopt_model_component/flixopt_models.py). You need to create a {py:class}`~encodapy.components.flixopt_model_component.flixopt_models.FlixOptModel` and add it to the component configuration  {py:class}`~encodapy.components.flixopt_model_component.flixopt_model_component_config.FlixoptModelComponentConfigData` as `flixopt_mode`.
...
Main configuration model: `FlixoptModelComponentConfigData` in [flixopt_model_component_config.py](https://github.com/gewv-tu-dresden/encodapy/blob/v0.10.2/encodapy/components/flixopt_model_component/flixopt_model_component_config.py).
...
See `FlixOptModel` in [flixopt_models.py](https://github.com/gewv-tu-dresden/encodapy/blob/v0.10.2/encodapy/components/flixopt_model_component/flixopt_models.py) for detailed field definitions and validation rules.
...
- The module must contain a function named `add_elements`, like it is shown in [add_elements.py](https://github.com/gewv-tu-dresden/encodapy/blob/v0.10.2/encodapy/components/flixopt_model_component/add_elements.py). The function needs to return list of flixopt elements (`list[fx.elements.Element]`) which should be added to the model.
...
- Value can be:
  - A Python file path (`*.py`), or
  - A Python module import path.
- The module must contain a function named `add_constraints`, like it is shown in [add_constraints.py](https://github.com/gewv-tu-dresden/encodapy/blob/v0.10.2/encodapy/components/flixopt_model_component/add_constraints.py)
...
- [examples/09_mpc_flixopt](https://github.com/gewv-tu-dresden/encodapy/blob/v0.10.2/examples/09_mpc_flixopt)

Relevant files:

- Example service configuration: [examples/09_mpc_flixopt/02_config_example.json](https://github.com/gewv-tu-dresden/encodapy/blob/v0.10.2/examples/09_mpc_flixopt/02_config_example.json)
- Example FlixOpt model: [examples/09_mpc_flixopt/02_flixopt_model_config.json](https://github.com/gewv-tu-dresden/encodapy/blob/v0.10.2/examples/09_mpc_flixopt/02_flixopt_model_config.json)
- Notebook to run the example: [examples/09_mpc_flixopt/run_example_optimisation.ipynb](https://github.com/gewv-tu-dresden/encodapy/blob/v0.10.2/examples/09_mpc_flixopt/run_example_optimisation.ipynb)
...
- Core implementation: [flixopt_model_component.py](https://github.com/gewv-tu-dresden/encodapy/blob/v0.10.2/encodapy/components/flixopt_model_component/flixopt_model_component.py)
- Config and runtime models: [flixopt_model_component_config.py](https://github.com/gewv-tu-dresden/encodapy/blob/v0.10.2/encodapy/components/flixopt_model_component/flixopt_model_component_config.py)
- FlixOpt schema models: [flixopt_models.py](https://github.com/gewv-tu-dresden/encodapy/blob/v0.10.2/encodapy/components/flixopt_model_component/flixopt_models.py)
