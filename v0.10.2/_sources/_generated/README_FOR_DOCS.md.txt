...
[![codecov](https://codecov.io/gh/gewv-tu-dresden/encodapy/graph/badge.svg?token=4556416BLJ)](https://codecov.io/gh/gewv-tu-dresden/encodapy)
...
- The Basic Service provides a system to
  ...
  - start a calculation
  - return the results
- This interaction is possible with several interfaces, see [examples/03_interfaces](https://github.com/gewv-tu-dresden/encodapy/blob/v0.10.2/examples/03_interfaces):
  - FIWARE-API
  - MQTT
  - File
...
- The framework provides components that can be used within a service. This is the recommended solution for running a functional service.
  For more information and code, see: [encodapy/components/readme.md](https://github.com/gewv-tu-dresden/encodapy/blob/v0.10.2/encodapy/components/readme.md)

- Further documentation can be found on our [website](https://gewv-tu-dresden.github.io/encodapy/).
- Examples and documentation for each part of the project are available under: [examples](https://github.com/gewv-tu-dresden/encodapy/blob/v0.10.2/examples)

## Configuration

- The configuration of the service must be provided via `config.json` and has several sections (see the [documentation](https://gewv-tu-dresden.github.io/encodapy/basic_service.html) or the [examples](https://github.com/gewv-tu-dresden/encodapy/blob/v0.10.2/examples)):
  ...
  - `controller_components`: Configuration of the controller components, see [encodapy/components/readme.md](https://github.com/gewv-tu-dresden/encodapy/blob/v0.10.2/encodapy/components/readme.md) or the [documentation](https://gewv-tu-dresden.github.io/encodapy/components.html)
  - `controller_settings`: General settings about the controller

- Environmental variables are required to configure the basic service and the interfaces. For more information, see [encodapy/config/env_values](https://github.com/gewv-tu-dresden/encodapy/blob/v0.10.2/encodapy/config/env_values.py) or the [documentation](https://gewv-tu-dresden.github.io/encodapy/).
...
To create your own custom service, you have to overwrite two functions of the [ControllerBasicService](https://github.com/gewv-tu-dresden/encodapy/blob/v0.10.2/encodapy/service/basic_service.py):
...
For more details, see the [examples](https://github.com/gewv-tu-dresden/encodapy/blob/v0.10.2/examples)

### Run Components with the ComponentRunnerService

- You could use components to run them with the [ComponentRunnerService](https://github.com/gewv-tu-dresden/encodapy/blob/v0.10.2/encodapy/service/component_runner_service.py)
- Frist, create a configuration, then start the service:
  - as shown in [examples/07_component_runner](https://github.com/gewv-tu-dresden/encodapy/blob/v0.10.2/examples/07_component_runner)
  - by running the service with the [encodapy.service.service_main](https://github.com/gewv-tu-dresden/encodapy/blob/v0.10.2/encodapy/service/service_main.py) function.
- If you need additional components, please see [encodapy/components](https://github.com/gewv-tu-dresden/encodapy/blob/v0.10.2/encodapy/components):
  - You can use components from `encodapy/components` or create your own
  - An easy way to build your own component is shown in [examples/08_create_new_component](https://github.com/gewv-tu-dresden/encodapy/blob/v0.10.2/examples/08_create_new_component)

### Examples

For different examples and documentation, how to use the tool - see [examples](https://github.com/gewv-tu-dresden/encodapy/blob/v0.10.2/examples).
...
- Inputs and outputs get information about the unit. The class [`DataUnits`](https://github.com/gewv-tu-dresden/encodapy/blob/v0.10.2/controller_software/utils/units.py) is used for this.
...
- Create a Python environment using Poetry (see [pyproject.toml](https://github.com/gewv-tu-dresden/encodapy/blob/v0.10.2/pyproject.toml)).
- For production deployments, use the [Dockerfile](https://github.com/gewv-tu-dresden/encodapy/blob/v0.10.2/Dockerfile) or the official Docker image.
- Use [dockerfile.dev](https://github.com/gewv-tu-dresden/encodapy/blob/v0.10.2/dockerfile.dev) for local development in Docker.
...
There are examples of how to use the image in [examples/07_component_runner](https://github.com/gewv-tu-dresden/encodapy/blob/v0.10.2/examples/07_component_runner) and [examples/05_simple_service_mqtt](https://github.com/gewv-tu-dresden/encodapy/blob/v0.10.2/examples/05_simple_service_mqtt). The working directory in the production image is `/app`, so you need to either mount the necessary files or change the environmental variables. See the documentation.
...
For information on contributions, see [CONTRIBUTING.md](https://github.com/gewv-tu-dresden/encodapy/blob/v0.10.2/CONTRIBUTING.md)
...
See [.github/workflows/README.md](https://github.com/gewv-tu-dresden/encodapy/blob/v0.10.2/.github/workflows/README.md) for details.

A changelog is attached with [CHANGELOG.md](https://github.com/gewv-tu-dresden/encodapy/blob/v0.10.2/CHANGELOG.md).
...
This project is licensed under the BSD License - see the [LICENSE](https://github.com/gewv-tu-dresden/encodapy/blob/v0.10.2/LICENSE) file for details.
