...
- Tests are structured as follows:
  - [core](./core/): Tests for the core functions of EnCoDaPy
    - See [core/README.md](./core/README.md) for detailed test organization and responsibility distribution
...
|-----------|---------------|------------|
| `basicservice/` | Service orchestrator | `ControllerBasicService` main class, service loops, data flow |
