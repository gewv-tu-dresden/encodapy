...
class TestIsGeoJson:
    ...
    def test_is_geojson_point(self):
        ...
        point_data = {"type": "Point", "coordinates": [100.0, 0.0]}
    ...
    def test_is_geojson_invalid_type(self):
        ...
        data = {"type": "InvalidType", "coordinates": [100.0, 0.0]}
    ...
    def test_is_geojson_type_not_string(self):
        ...
        data = {"type": 123, "coordinates": [100.0, 0.0]}
...
class TestValidateDatatypeAgainstValue:
    ...
    def test_validate_datatype_boolean(self):
        ...
        result = service._validate_datatype_against_value(
            mock_attribute, mock_component
        )
...
class TestProcessAttributes:
    ...
    def test_process_attributes_match(self):
        ...
        output_entity = OutputModel(
            ...
            attributes=[
                AttributeModel(
                    id="temperature", datatype=DataType.NUMBER, name="Temperature"
                )
            ],
        )
    ...
    def test_process_attributes_multiple_attributes(self):
        ...
        output_entity = OutputModel(
            ...
            attributes=[
                ...
                AttributeModel(
                    id="pressure", datatype=DataType.NUMBER, name="Pressure"
                ),
                AttributeModel(
                    id="humidity", datatype=DataType.NUMBER, name="Humidity"
                ),
            ],
        )
    ...
    def test_process_attributes_datatype_validation(self):
        ...
        output_entity = OutputModel(
            ...
            interface=Interfaces.FIWARE,
            attributes=[
                AttributeModel(id="status", datatype=DataType.TEXT, name="Status")
            ],
        )
...
class TestProcessCommands:
    ...
    def test_process_commands_supported_types(self, value):
        ...
        output_entity = OutputModel(
            ...
            interface=Interfaces.FIWARE,
            attributes=[],
            commands=[CommandModel(id="command_1", value=None)],
        )
    ...
    def test_process_commands_unsupported_type_warning(self):
        ...
        assert (
            "int, float, str, bool, dict, list" in source
            or "isinstance(component.value" in source
        )
