...
class TestLoadConfig:
    ...
    def test_load_config_success(self, mock_from_json, mock_config_all_interfaces):
        """
        ...
        mock_from_json.assert_called_once_with(
            file_path="tests/fixtures/test_config.json"
        )

    @patch("encodapy.service.basic_service.ConfigModel.from_json")
    def test_load_config_fiware_interface_enabled(
        self, mock_from_json, mock_config_only_fiware
    ):
        """
        ...
        with (
            patch.object(service, "load_fiware_params") as mock_load_fiware,
    ...
    def test_load_config_file_interface_enabled(
        self, mock_from_json, mock_config_all_interfaces, service_with_no_config
    ):
        """
        ...
        with (
            patch.object(
                service_with_no_config, "load_fiware_params"
            ) as _mock_load_fiware,
            patch.object(service_with_no_config, "load_file_params") as mock_load_file,
            patch.object(service_with_no_config, "load_mqtt_params") as _mock_load_mqtt,
        ):
    ...
    def test_load_config_mqtt_interface_enabled(
        ...
        with (
            ...
            patch.object(service_with_no_config, "load_file_params") as _mock_load_file,
    ...
    def test_load_config_file_not_found_error(
        self, mock_logger, mock_from_json, service_with_no_config
    ):
        """
        ...
        with patch.object(service_with_no_config, "load_fiware_params"):
            ...
            assert "Error loading configuration file" in str(
    ...
    def test_load_config_debug_log_on_success(
        ...
        with (
            patch.object(service_with_no_config, "load_fiware_params"),
...
class TestLoadConfigInterfaces:
    ...
    def test_load_config_all_interfaces_disabled(
        self, mock_from_json, mock_config_no_interfaces, service_with_no_config
    ):
        """
        ...
        with (
            patch.object(service_with_no_config, "load_fiware_params") as mock_fiware,
    ...
    def test_load_config_only_fiware_enabled(
        self, mock_from_json, mock_config_only_fiware, service_with_no_config
    ):
        """
