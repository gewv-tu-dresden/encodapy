...
class TestLoggerControl:
    ...
    def test_normalizes_numeric_environment_values(self, mock_add, tmp_path: Path):
    ...
    @patch("encodapy.utils.logging.logger.add")
    def test_preserves_loguru_text_and_timedelta_values(self, mock_add, tmp_path: Path):
    ...
    @patch("encodapy.utils.logging.logger.add")
    def test_creates_nested_log_directories(self, mock_add, tmp_path: Path):
