...
- ThermalStorage (`thermal_storage`): Thermal storage component to calculate the stored energy using temperature sensors.  
  An example can be found under: [`examples/06_thermal_storage_service`](https://github.com/gewv-tu-dresden/encodapy/blob/v0.10.1/examples/06_thermal_storage_service)
- TwoPointController (`two_point_controller`): Two-Point-Controller component for the steering of the loading process of a thermal storage or other processes.  
  An example can be found under: [`examples/07_component_runner`](https://github.com/gewv-tu-dresden/encodapy/blob/v0.10.1/examples/07_component_runner)
- Pradictiv Control model with FlixOpt [`flixopt_model_component`]: Component for optimisation within operational management with [FlixOpt](https://github.com/flixOpt/flixopt)  
  An example can be found under [`examples/09_flixopt`](https://github.com/gewv-tu-dresden/encodapy/blob/v0.10.1/examples/09_flixopt).
...
[`encodapy/components/thermal_storage/thermal_storage_config.py`](https://github.com/gewv-tu-dresden/encodapy/blob/v0.10.1/encodapy/components/thermal_storage/thermal_storage_config.py)

---

## Implementing a New Component

- an example is provided in [`examples/08_create_new_component`](https://github.com/gewv-tu-dresden/encodapy/blob/v0.10.1/examples/08_create_new_component)
