...
[`encodapy/components/thermal_storage/thermal_storage_config.py`](https://github.com/gewv-tu-dresden/encodapy/blob/main/encodapy/components/thermal_storage/thermal_storage_config.py)

---

## Implementing a New Component

- an example is provided in [`examples/08_create_new_component`](https://github.com/gewv-tu-dresden/encodapy/blob/main/examples/08_create_new_component)
