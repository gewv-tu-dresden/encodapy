...
An overview is available as Pydantic BaseModel {py:class}`~encodapy.components.thermal_storage.thermal_storage_config.ThermalStorageOutputData` in [thermal_storage_config.py](https://github.com/gewv-tu-dresden/encodapy/blob/main/encodapy/components/thermal_storage/thermal_storage_config.py).
...
For detailed documentation of the inputs, see the {py:class}`~encodapy.components.thermal_storage.thermal_storage_config.ThermalStorageInputData` in [thermal_storage_config.py](https://github.com/gewv-tu-dresden/encodapy/blob/main/encodapy/components/thermal_storage/thermal_storage_config.py) or the documentation.

## Example

An example how the component could be used is available in [examples/06_thermal_storage_service](https://github.com/gewv-tu-dresden/encodapy/blob/main/examples/06_thermal_storage_service)